...
export default function SilverAge() {
  ...
  const cards = [
    ...
    { icon: BookHeart, title: language === "en" ? "Share Wisdom" : "ज्ञान साझा करें", desc: language === "en" ? "Share life experiences with younger women" : "युवा महिलाओं के साथ अनुभव साझा करें", gradient: "gradient-silver" },
    ...
    { icon: Users, title: language === "en" ? "Mentoring" : "मेंटरिंग", desc: language === "en" ? "Chat with younger generations" : "युवा पीढ़ी से बात करें", gradient: "gradient-silver" },
  ];
